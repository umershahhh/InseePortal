...
const navItems = [
  { icon: <DashIcon />,   label: 'Overview',   href: '/admin' },
  { icon: <UsersIcon />,  label: 'Users',      href: '/admin#users' },
  { icon: <DeviceIcon />, label: 'Devices',    href: '/admin#devices' },
  { icon: <AlertIcon />,  label: 'All Alerts', href: '/admin#alerts' },
  { icon: <SysIcon />,    label: 'System',     href: '/admin#system' },
]
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        {/* Admin badge */}
        <div style={{ padding:'10px 16px', borderBottom:'1px solid var(--s-border)' }}>
          <div style={{ display:'inline-flex', alignItems:'center', gap:6, background:'rgba(124,58,237,0.15)', border:'1px solid rgba(124,58,237,0.25)', borderRadius:6, padding:'3px 10px', fontFamily:'var(--font-dm)', fontSize:'0.7rem', fontWeight:600, color:'#A78BFA', textTransform:'uppercase', letterSpacing:'0.08em' }}>
            <StarIcon /> Super Admin
          </div>
        </div>
        ...
        <nav style={{ padding:'14px 10px', flex:1 }}>
          ...
          <div style={{ height:1, background:'var(--s-border)', margin:'14px 8px' }} />
          <div style={{ fontFamily:'var(--font-dm)', fontSize:'0.66rem', fontWeight:600, color:'rgba(148,163,184,0.45)', textTransform:'uppercase', letterSpacing:'0.1em', padding:'0 8px', marginBottom:8 }}>
            Quick links
          </div>
          <Link href="/dashboard" className="sidebar-nav-item" style={{ marginBottom:2 }} onClick={onClose}>
            <MapIcon /> Caretaker View
          </Link>
        </nav>
        ...
        <div style={{ padding:'8px 10px 14px' }}>
          <div style={{ display:'flex', alignItems:'center', gap:10, padding:'10px 8px', marginBottom:4 }}>
            <div style={{ width:32, height:32, borderRadius:'50%', background:'linear-gradient(135deg,#7C3AED,#2563EB)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="white"><path d="M12 1l3.09 6.26L22 8.27l-5 4.87 1.18 6.88L12 16.77l-6.18 3.25L7 13.14 2 8.27l6.91-1.01L12 1z"/></svg>
            </div>
            <div>
              <div style={{ fontFamily:'var(--font-dm)', fontSize:'0.85rem', fontWeight:500, color:'#F1F5F9' }}>Super Admin</div>
              <div style={{ fontFamily:'var(--font-dm)', fontSize:'0.7rem', color:'#64748B' }}>Full access</div>
            </div>
          </div>
...
function LogoSVG() {
  return (
    <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="8" fill="url(#adm-logo-g)" />
...
function UsersIcon()  { return <svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/><circle cx="9" cy="7" r="4" stroke="currentColor" strokeWidth="1.8"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg> }
...
function SysIcon()    { return <svg width="17" height="17" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.8"/><path d="M19.07 4.93A10 10 0 004.93 19.07M4.93 4.93a10 10 0 0014.14 14.14" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg> }
...
function SignOutIcon(){ return <svg width="15" height="15" viewBox="0 0 24 24" fill="none"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg> }
function StarIcon()   { return <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1l3.09 6.26L22 8.27l-5 4.87 1.18 6.88L12 16.77l-6.18 3.25L7 13.14 2 8.27l6.91-1.01L12 1z"/></svg> }
